...
function REMethodDefinition:get_return_type() return re_type end
---@return void_ptr pointer Pointer to the actual function in memory.
function REMethodDefinition:get_function() return pointer end
...
function RETypeDefinition:get_method(name) return method end

---Returns a list of REMethodDefinition
---Filters out methods that are potentially just stubs or null.
---@return REMethodDefinition[]
function RETypeDefinition:get_methods() return methods end
---Returns an REField
---@param name string field name
---@return REField
function RETypeDefinition:get_field(name) return field end
---returns list of REField
---@return REField[]
function RETypeDefinition:get_fields() return fields end
---Returns the RETypeDefinition this type inherits from.
---@return RETypeDefinition
function RETypeDefinition:get_parent_type() return re_type end
---Returns a System.Type. Useful for methods that require this. Equivalent to typeof in C#.
function RETypeDefinition:get_runtime_type() return re_type end
---Returns the full size of the object. e.g. 0x14 for System.Int32.
---@return integer
function RETypeDefinition:get_size() return size end
...
function REManagedObject:call(method_name,...) return value end
---desc
---@param name string field name
---@return unknown field return type is dependent on the field type
function REManagedObject:get_field(name) return field end
...
function REManagedObject:get_address() return address end
...
function sdk.get_tdb_version() return version end
...
function sdk.game_namespace(name) return namespace end
...
---@param name string
---@return RETypeDefinition
function sdk.find_type_definition(name) return re_type end
...
function sdk.create_instance(typename, simplify) return instance end 

---Creates and returns a new System.String from str.
function sdk.create_managed_string(str) return sys_string end
...
function sdk.deserialize(data) return list end
...
function sdk.call_native_func(object, type_definition, method_name, ...) return value end
...
---@param ... any function arguments
---@return unknown value dependent on what the method returns.
function sdk.call_object_func(managed_object, method_name, ...) return value end
...
function sdk.get_primary_camera() return camera end
...
function sdk.is_managed_object(value) return is_managed_object end
...
function sdk.to_managed_object(value) return object end

--Attempts to convert value to a double.
---@param value void_ptr void*
---@return number double
function sdk.to_double(value) return double end
...
---@param value void_ptr void*
---@return number float
function sdk.to_float(value) return float end
...
---@param value void_ptr void*
---@return integer int
function sdk.to_int64(value) return int end
...
function sdk.to_ptr(value) return pointer end
