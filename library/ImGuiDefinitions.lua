...
function imgui.begin_window(name,open,flags)
end
...
---@param flags any ImGuiWindowFlags
function imgui.begin_child_window(size,border,flags)
    
end

function imgui.end_child_window()
...
function imgui.begin_rect()
    
end

---draw a rectangle around the elements between `begin_rect` and `end_rect`
function imgui.end_rect(additional_size,rounding)
...
---@param flags any
function imgui.invisible_button(id, size, flags)
    
end

---@param id any
---@param dir any dir is an `ImguiDir`
function imgui.arrow_button(id,dir)
...
function imgui.text_colored(text,color)
...
function imgui.tree_node_ptr_id(id, label)
    
end

function imgui.tree_node_str_id(id, label)
...
function imgui.collapsing_header(name)
...
function imgui.get_default_font_size()
...
---@param pivot any
function imgui.set_next_window_pos(pos, condition, pivot )
...
---@param size any
---@param condition ImGuiCond_
function imgui.set_next_window_size(size, condition)
    
end

---@param id integer|string|void_ptr can be an `int`, `const char*`, or `void*`.
function imgui.push_id(id)
